...
@version:
@Author: XiaoYang
@Date: 2020-04-21 10:36:06
@LastEditors: XiaoYang
@LastEditTime: 2020-04-21 10:51:57
'''
# -*- coding: utf-8 -*-
...
import random
import csv
from setting import User_Agent_List, xiecheng_name_idx
...
def create_travels_users(addr, idx, min, max):
    # 1. 创建文件对象
    f1 = open('./{}-{}-users_urls.csv'.format(idx, xiecheng_name_idx[idx]), 'a', encoding='utf-8')
    f2 = open('./{}-{}-travels_urls.csv'.format(idx, xiecheng_name_idx[idx]), 'a', encoding='utf-8')
    ...
    for i in range(min, max):
        try:
            url = "https://you.ctrip.com/travels/{}/s2-p".format(idx) + str(i) + ".html"
...
if __name__ == "__main__":
    create_travels_users('XieCheng', "xitang15", 1, 500)
